...
// to add the slot 
 ...
 // if date is today then prevent  past time 
    if (slotDate === today) {
      const now = new Date();
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE = `${(import.meta.env.VITE_BACKEND_URL || "http://localhost:4000").replace(/\/+$/, "")}/api`;
    ...
    <div className={s.pageContainer}>
      ...
      <div className={s.maxWidthContainer+ " " +s.formContainer}>
         ...
         <form onSubmit={handleAdd} className={s.formGrid}>
          ...
          <input className={s.inputBase} placeholder='Full Name' value ={form.name}
          onChange={(e)=>setForm({...form,name: e.target.value})} />
          
          <input className={s.inputBase} placeholder='Specialization' value ={form.specialization}
          onChange={(e)=>setForm({...form,specialization: e.target.value})} />

          <input className={s.inputBase} placeholder='Location' value ={form.location}
          onChange={(e)=>setForm({...form,location: e.target.value})} />

           
           <input className={s.inputBase} placeholder='Experience' value ={form.experience}
          onChange={(e)=>setForm({...form,experience: e.target.value})} />

          <input className={s.inputBase} placeholder='Qualification' value ={form.qualifications}
          onChange={(e)=>setForm({...form,qualifications: e.target.value})} />

          <input className={s.inputBase} placeholder='Consultation Fee' value ={form.fee}
          ...
          <input className={s.inputBase} placeholder='Patients' value ={form.patients}
          onChange={(e)=>setForm({...form,patients: e.target.value})} />

          
          <input className={s.inputBase} placeholder='Success Rate' value ={form.success}
          onChange={(e)=>setForm({...form,success: e.target.value})} />
          
          
          <input className={s.inputBase} placeholder='Email' value ={form.email}
