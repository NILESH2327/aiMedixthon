...
import { AlertTriangle, Calendar, Check, CheckCircle, Clock, Image, Plus, Trash2, XCircle } from 'lucide-react';
            ...
            <button type='submit' disabled={submitting} className={addServiceStyles.buttons.submit}>
              {
                submitting ?(
                  <>
                  <div className='w-4 h-4 border-2 border-white border-t-transparent rounded-fulll animate-spin'>
                    Saving...
                  </div>
                  </>
                ):(
                  ...
                  {serviceId ? "Update service" : "Save server"}
