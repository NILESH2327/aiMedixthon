...
const Dashboard = () => {
  ...
  // to load doctors from serverside
       ...
       <div className={s.maxWidthContainer}>
        ...
        <div className={s.statsGrid}>
          ...
          label="Total Doctors" value ={totals.totalDoctors} />
           ...
           {/* show count fetch from the backend  */}
          <StatCard icon ={<UserRoundCheck className= "w-6 h-6"/>}
          label="Total Refistered Users" value ={
         ...
         <StatCard icon ={<XCircle className= "w-6 h-6"/>}
          label="cancel" value =  {`${totals.canceled}`}/>


        </div>
        <div className='mb-6'>
          {/* yaha se shuru karo  4:20 */}
      ...
      <div className={s.mobileDoctorHeader}>
        <div className="flex items-center gap-3">
            ...
            <div>
             ...
             <div className={s.mobileDoctorSpecialization}>{d.specialization}
