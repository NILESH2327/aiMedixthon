...
import { HandCoins, Mail, MapPin, MessageSquare, Phone, SendHorizontal, Stethoscope, User } from 'lucide-react';
...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/9555992690?text=${encodeURIComponent(text)}`;
      ...
      {errors.email && (
       ...
       <div className={contactPageStyles.formGrid}>
            ...
            <div>
              ...
              />
               {errors.message && (
                <p className={contactPageStyles.message}>
                  {errors.message}
                </p>
              )}
            </div>
        ...
        <div className={contactPageStyles.infoContainer}>
          ...
          <iframe
           src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56978.31826276996!2d82.71048837783162!3d26.80351474908105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3990daa920256eb5%3A0xdfea9251f4223af6!2sBasti%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1783049960828!5m2!1sen!2sin"
            className={contactPageStyles.map}
            title="Basti, Uttar Pradesh, India"
            loading="lazy"
            allowFullScreen
          ></iframe>
